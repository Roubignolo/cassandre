            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        ...
                        <a href="create_clients.php" class="btn btn-success pull-right">Ajouter un nouvel exercice</a>
                    </div>
                    <?php
                    // Include config file
                    require_once "config.php";
